...
public class MainGameController : MonoBehaviour {
	...
	public void resetStart() {
		...
		player.transform.localPosition = new Vector2 (0, 0); 		camera.GetComponent<DeadzoneCamera> ().activeCamera = false; 		camera.GetComponent<DeadzoneCamera> ().MoveToSourceNode ();
